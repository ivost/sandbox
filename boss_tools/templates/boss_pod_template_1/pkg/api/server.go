...
import (
	...
	_ "github.com/braincorp/boss_pod_template/pkg/api/docs"
	"github.com/braincorp/boss_pod_template/pkg/fscache"
...
// @contact.url https://github.com/braincorp/boss_pod_template

// @license.name MIT License
// @license.url https://github.com/braincorp/boss_pod_template/blob/master/LICENSE
...
func (s *Server) ListenAndServe(stopCh <-chan struct{}) {
	...
	go func() {
		s.logger.Sugar().Infof("Server %+v", srv)
		if err := srv.ListenAndServe(); err != http.ErrServerClosed {
			s.logger.Fatal("HTTP server crashed", zap.Error(err))
		}
		//l, err := net.Listen("tcp4", srv.Addr)
		//if err != nil {
		//	//	s.logger.Fatal("HTTP server crashed", zap.Error(err))
		//}
